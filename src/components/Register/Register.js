                ...
                <div className={classes.paper}>
                    ...
                    <TabContent activeTab={activeTab} style={{ border: '1px solid #eee', width: '400px', padding: '10px' }}>
                        <TabPane tabId="1">
                            ...
                            <Form>
                                <FormGroup>
                                    <Input type="text" name="name" placeholder="Enter Full Name" autoComplete="none" />
                                </FormGroup>
                                <FormGroup>
                                ...
                                <FormGroup>
                                    <button className="btn btn-danger form-control mt-3 mb-2">Sign Up</button>
                                </FormGroup>
                            </Form>
                            <Label>Already have an account? <Link href="/login" className="text-danger">Click here</Link> to Log in</Label>
                        </TabPane>
                        <TabPane tabId="2">
                            <Typography component="h6" variant="h6" style={{ textAlign: 'center', marginTop: '20px', marginBottom: '10px' }}>
                                Admin Sign up
